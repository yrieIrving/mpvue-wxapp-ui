<template>
  <div class="page">
    <div class="page">
      <div class="page__hd">
        <div class="page__title">{{str}}</div>
        <div class="page__desc">按钮，WeUI采用小程序原生的按钮为主体，加入一些间距的样式。{{str}}</div>
      </div>
      <div class="page__bd page__bd_spacing">
        ...
        <div class="button-sp-area">
          ...
          <button class="weui-btn mini-btn" type="warn" size="mini" >按钮123</button>
        </div>
      </div>
    </div>
  </div>
